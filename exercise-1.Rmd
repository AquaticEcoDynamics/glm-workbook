...
<center>
```{r picex1-2, echo=FALSE, fig.cap="", out.width = '75%'}
knitr::include_graphics("images/Exercises/Waterbalance.jpg")
```
</center>

Plot the lake water balance -- volume, water level and fluxes including inflows, outflows, rainfall and evaporation. Remember to label all the variables and units that you plot. Close the `lake.csv` file before you run the model again.

<center>
```{r picex1-3, echo=FALSE, fig.cap="", out.width = '75%'}
knitr::include_graphics("images/Exercises/Waterbalanceplot.jpg")
```
</center>
