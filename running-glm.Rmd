...
To launch GLM, first open a new terminal session from the menu bar. Depending on your operating system, the commands to run the simulation will differ:
...
<center>
<video width="100%" height="100%" controls>
  <source src="images/09-module8/run_chmod.mp4" type="video/mp4">
</video>
</center>
