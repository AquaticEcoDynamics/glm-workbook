...
For users new to Python, it is recommended that you first complete the [Bonus Exercise](#glmpy-exercise) before installing Python and glm-py on your computer. You will use a browser-based Python notebook that won't require installing any software on your computer.
